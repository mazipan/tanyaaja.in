  ...
  return (
    <main className="w-full container py-8">
      ...
      <div className="w-full flex flex-col gap-4">
        <p className="mb-4">
          Kami di <b>TanyaAja</b> menyadari bahwa Anda mengharapkan privasi dan
          ...
          memahami kebutuhan untuk melindungi informasi yang mungkin Anda
          berikan kepada kami di situs web kami.
        </p>

        <div className="mb-4">
          <h2 className="mb-2 text-xl font-bold">
            🔹 Mengapa <b>TanyaAja</b> meminta informasi tentang Anda
          </h2>
          <p>
            <b>TanyaAja</b> mengumpulkan dan menyimpan Informasi Pribadi tentang
            ...
            untuk menggunakan layanan <b>TanyaAja</b> (kami akan menanyakan nama
            dan alamat email Anda), dan saat Anda mendaftar untuk layanan
            berbayar (kami akan meminta informasi umum seperti nama, alamat
            email, alamat penagihan, dan informasi kartu kredit Anda). Kami
            menggunakan informasi tersebut untuk bertransaksi bisnis dengan Anda
            dan memberikan layanan yang diminta dari waktu ke waktu, serta
        ...
        <div className="mb-4">
          <h2 className="mb-2 text-xl font-bold">
            🔹 Bagaimana <b>TanyaAja</b> melindungi informasi Anda
          </h2>
          <p>
            Informasi yang kami terima dari Anda dilindungi dari akses tidak sah
            setelah kami menerimanya. Kami membatasi akses ke informasi Anda
            hanya untuk karyawan yang memiliki alasan bisnis untuk mengaksesnya.
            Saat mengumpulkan informasi keuangan dari Anda, kami menggunakan
            perangkat lunak lapisan soket aman (SSL). Terlepas dari upaya kami
            yang terus menerus dan berkembang untuk melindungi informasi pribadi
            Anda, kami tidak dapat menjamin keamanan Informasi Pribadi Anda.
            Anda mengakui dan setuju bahwa kami tidak memberikan jaminan seperti
            itu.
          </p>
        </div>
        ...
        <div className="mb-4">
          ...
          <p>
            ...
            <b>TanyaAja</b>. Kami memiliki kode, database, dan semua hak atas
            aplikasi
        ...
        <div className="mb-4">
          ...
          <p>
            ...
            situs web kami, seperti waktu yang dihabiskan pengguna di suatu
            situs dan halaman yang paling sering mereka kunjungi. Statistik
            tersebut tidak mengandung Informasi Pribadi. Kami juga akan
        ...
        <div className="mb-4">
          ...
          <p>
            ...
            Beberapa tautan mungkin dalam bentuk iklan tampilan. Kami tidak
            dapat menjamin bahwa situs web selain situs web kami akan
            menghormati dan melindungi Informasi Pribadi Anda seperti yang kami
            lakukan. Untuk perlindungan Anda sendiri, Anda harus mengunjungi dan
            membaca pernyataan / kebijakan privasi situs web lain saat Anda
        ...
        <div className="mb-4">
          ...
          <p>
            Ketika Anda memberikan Informasi Pribadi kepada kami, Anda
            menyetujui pengumpulan dan penggunaan informasi ini oleh{' '}
            <b>TanyaAja</b>.
          </p>
        </div>
        ...
        <div className="mb-4">
          ...
          <p>
            Jika <b>TanyaAja</b>, atau secara substansial semua asetnya
            ...
            ketiga. Anda mengakui bahwa transfer tersebut dapat terjadi, dan
            bahwa setiap pihak yang mengakuisisi <b>TanyaAja</b>
