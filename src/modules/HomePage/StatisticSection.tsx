...
export const StatistikSection = ({
  ...
  return (
    <section className="relative container mx-auto max-w-[58rem] py-8 my-12 flex flex-col justify-center items-center gap-4 overflow-hidden">
      <BlurIn
        word="Statistik"
      ...
      <div className="relative space-y-4 rounded-2xl w-[80%] flex justify-center flex-col gap-4 items-center mx-auto">
        <h3 className="font-mono font-light md:text-xl text-center mt-12">
          PENGGUNA TERDAFTAR
        </h3>
        <HyperText
        ...
        />
        <h3 className="mt-12 font-mono font-light md:text-xl text-center">
          JUMLAH PERTANYAAN
        </h3>
        <HyperText
          className="font-extrabold max-w-[85%] text-center text-4xl sm:text-5xl md:text-6xl lg:text-7xl"
