    ...
    (
      <div tw="flex p-4 flex-col w-full h-full items-center justify-center bg-white">
          ...
          {type === 'user' && user ? (
            <div tw="flex font-bold text-4xl tracking-tight">
              <span>
                ...
                ke {decodeURIComponent(user)} dengan{' '}
              </span>
        ...
        <div tw="flex mb-2 items-center justify-center mt-10">
          ...
          >
            <path
              d="M438.524 0H61.4764C27.5274 0 0 25.5531 0 57.0674V314.823C0 346.342 27.5221 371.896 61.4764 371.896H109.681L109.708 419L173.157 371.896H438.524C472.478 371.896 500 346.342 500 314.823V57.0674C500 25.5531 472.478 0 438.524 0ZM270.095 308.042H217.156V258.895H270.095V308.042ZM306.71 184.99C284.79 192.763 270.735 207.759 270.735 230.135H216.511C216.511 173.098 255.718 155.936 280.691 150.338C296.004 146.906 310.736 142.423 311.566 123.086C312.238 107.496 302.405 88.2821 260.743 89.053C214.575 89.9123 211.486 121.309 211.338 131.723L157.114 132.347C157.045 128.929 157.135 98.2402 182.821 73.9097C201.848 55.884 228.82 46.746 262.986 46.746C342.643 46.746 362.479 93.8111 363.696 118.662C365.727 160.213 330.519 176.55 306.71 184.99Z"
              fill="#8ABCD7"
            />
          </svg>
