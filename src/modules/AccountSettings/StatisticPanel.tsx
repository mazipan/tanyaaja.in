  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
      ...
      >
        ...
        <p className="text-4xl font-extrabold">{new Intl.NumberFormat('id-ID').format(owner?.count || 0)}</p>
      ...
      >
        ...
        <div className="flex gap-2 items-center mt-4">
          <Link2Icon />
          <a className='underline text-sm' href={`${BASEURL}/p/${owner?.slug}`} target='_blank' rel="noopener noreferrer" >
